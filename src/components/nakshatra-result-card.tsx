...
export function NakshatraResultCard({ result, onReset }: NakshatraResultCardProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
        ...
        >
            <div className="flex-grow flex flex-col justify-center items-center text-center z-10 space-y-6">
                <div>
            ...
            <CardFooter className="flex-col pt-8 pb-0 px-0 items-center justify-center space-y-3">
