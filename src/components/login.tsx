  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-sm text-center p-8">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-primary mb-2">Welcome to Naamkarann</DialogTitle>
          <DialogDescription className="text-muted-foreground mb-6">Sign in to find the perfect name.</DialogDescription>
        </DialogHeader>
