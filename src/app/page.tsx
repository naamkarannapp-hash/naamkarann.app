...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <main className="flex flex-col items-center text-center p-4 pt-8 md:pt-12">
        ...
        <div className="my-2 md:my-6 flex flex-col items-center h-20">
       ...
       <footer className="w-full mt-auto py-4 px-4 flex flex-col items-center space-y-4">
