...
export const metadata: Metadata = {
    title: 'Contact Us | Naamkarann',
    description: 'Get in touch with the Naamkarann team. We\'d love to hear your questions, feedback, or suggestions about our baby name generator.',
};
